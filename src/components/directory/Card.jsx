    ...
    <>
      <div className="w-full h-full border-2 border-transparent rounded-2xl shadow-lg">
        ...
        <div className="p-4 flex flex-col">
          ...
          <div className="w-full">
            <p className="text-xs font-semibold my-2 text-gray-700">Gudalajara</p>
            <div className="flex flex-col">
              <div className="flex flex-row">
                <img src={incDirection} alt="" srcSet="" />
                <p className="ml-4 text-xs font-medium text-gray-500">Miguel Gordoa #1782 Int 2 Col. Guadalupana Sur</p>
              </div>
              <div className="flex flex-row">
                <img src={incDirection} alt="" srcSet="" />
                <p className="ml-4 text-xs font-bold text-gray-500">(333) 31 27 16 54 / (333) 35 43 52 72</p>
              </div>
              <div className="flex flex-row">
                <img src={incDirection} alt="" srcSet="" />
                <p className="ml-4 text-xs font-medium text-gray-500">nutrikarinagut@gmail.com</p>
              </div>
            </div>
          </div>
          <div className="w-full flex fle-row justify-between border-t-2 mt-4 border-gray-150">
            <div className="flex flex-row">
              ...
              <div className="flex flex-col ml-4">
                ...
                <div className="text-xs text-gray-400 font-bold">Nutrikarinagut</div>
              </div>
            </div>
            <div className="flex flex-row">
